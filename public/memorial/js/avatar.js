...
window.setTheme = function (theme) {
    ...
    switch (theme) {
        ...
        case 'night':
            ...
            break;
        case 'nature':
            container.classList.add('bg-gradient-to-b', 'from-primary-300', 'to-primary-100');
            break;
        case 'cozy':
            container.classList.add('bg-gradient-to-b', 'from-secondary-200', 'to-secondary-50');
            break;
        default:
            // Match the default page theme (Nature/Green)
            container.classList.add('bg-gradient-to-b', 'from-primary-200', 'to-primary-50');
    }
